...
PLOT_PEAK_PREDIC_LAEQ_MEAN_WEEK = True

PLOT_PEAK_BOX_PLOT_PREDICTION = True
PLOT_PEAK_BOX_PLOT_PREDICTION_WEEK = True

PLOT_PEAK_HEATMAT_PREDICTION = True
PLOT_PEAK_HEATMAT_PREDICTION_WEEK = True
