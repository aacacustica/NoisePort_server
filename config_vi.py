...
RELATIVE_PATH_YAMNET_MAP = "/Modelos_IA/AAC_IA_Puerto/yamnet_class_AAC_v3_0.csv"
RELATIVE_PATH_TAXONOMY_URBAN = "/Modelos_IA/taxonomies_json/urban_taxonomy_map_v1_0.json"
RELATIVE_PATH_TAXONOMY_PORT = "/Modelos_IA/taxonomies_json/port_1_taxonomy_mapping_v2.0.json"
...
PLOT_NIGHT_EVOLUTION_WEEK = False # Falla, no coge datos de la semana completa.

PLOT_NIGHT_EVOLUTION_15_MIN = True
PLOT_NIGHT_EVOLUTION_15_MIN_WEEK = True


# prediction
PLOT_PREDIC_LAEQ_MEAN = True
PLOT_PREDIC_LAEQ_MEAN_WEEK = True
PLOT_PREDIC_LAEQ_MEAN_4H = True
PLOT_PREDIC_LAEQ_DAY = True


PLOT_PREDIC_LAEQ_15_MIN_PERIOD = True
PLOT_PREDIC_LAEQ_15_MIN_PERIOD_WEEK = True


PLOT_PREDIC_LAEQ_15_MIN_4H = True
PLOT_PREDIC_LAEQ_15_MIN_4H_WEEK = True

PLOT_PREDICTION_STACK_BAR = True
PLOT_PREDICTION_STACK_BAR_WEEK = True
...
PLOT_MAKE_TIME_PLOT_WEEK = True

PLOT_HEATMAP_EVOLUTION_HOUR = True 
PLOT_HEATMAP_EVOLUTION_HOUR_WEEK = True

PLOT_HEATMAP_EVOLUTION_15_MIN = True 
PLOT_HEATMAP_EVOLUTION_15_MIN_WEEK = True

PLOT_INDICADORES_HEATMAP = True
PLOT_INDICADORES_HEATMAP_WEEK = True



PLOT_DAY_EVOLUTION = True
PLOT_DAY_EVOLUTION_WEEK = True

PLOT_PERIOD_EVOLUTION = True
PLOT_PERIOD_EVOLUTION_WEEK = True
